...
```
#extreme right/left values because WSLS tends to stay a bunch or shift a bunch (depending on the value of the win_stay and lose_shift) --> trends towards extremes
```{r}
